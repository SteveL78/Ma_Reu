...
public abstract class DummyMeetingGenerator {
    ...
    public static List<Meeting> DUMMY_MEETINGS = Arrays.asList(
            ...
            new Meeting(1200, "Réunion C", getDate("05/07/2020 14:00"), getDate("05/07/2020 14:45"), RoomGenerator.DUMMY_ROOMS.get(9), Collections.singletonList(ParticipantGenerator.DUMMY_PARTICIPANTS.get(4)))
    );
